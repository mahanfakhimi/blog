    ...
    <styled.div display="flex" columnGap="20px">
      ...
      <styled.div>
        <styled.div display="flex" alignItems="center" columnGap="10px" mb="8px">
          <a href="#">
            <Avatar size="SM" src="https://miro.medium.com/v2/resize:fill:110:110/1*kNiE7VKg3MmYmMQ9EABO0Q.jpeg" />
          </a>
        ...
        <styled.h2 fontWeight="700" fontSize="16px" mb="8px" lineClamp="2">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, nam quae possimus officiis autem magnam, est
          laboriosam in, doloribus expedita optio ut. Nulla quasi assumenda repellat. Error laudantium aliquam atque!
        </styled.h2>
